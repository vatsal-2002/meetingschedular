    ...
    try {
      ...
      if (confirmDelete) {
        ...
        if (response.status === 200) {
          ...
          toast.success('Meeting deleted successfully.', { position: 'top-center', autoClose: 500 });
        } else {
          console.error("Error deleting meeting:", response.statusText);
          // Show error toast message
          toast.error('Error deleting meeting. Please try again later.', { position: 'top-center', autoClose: 1000 });
        }
      }
    } catch (error) {
          ...
          <div className="container-fluid">
            <div className="layout-specing">
              <div className="d-md-flex justify-content-between align-items-center">
                <h4 className="mb-0">Event types</h4>
              </div>
              <hr />
              <div className="row">
