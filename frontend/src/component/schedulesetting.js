...
//   //         const bookedStartTime = new Date(item.start_time);
//   //         const bookedEndTime = new Date(item.end_time);
...
//   //         return (
//   //           slotStartTime.getTime() >= bookedStartTime.getTime() &&
//   //           slotStartTime.getTime() < bookedEndTime.getTime()
//   //         );
//   //       });

//   //       return isTimeSlotBooked ? null : (
//   //         <button className="btn btn-primary mx-3 mb-1" key={key}>
//   //           {formattedStartTime}
//   //         </button>
//   //       );
...
//     // Extract booked times from slotbookedData
//     slotbookedData.forEach((item) => {
//       const startTime = item.start.split(' ')[1]; // Extract time from start date
//       const endTime = item.end.split(' ')[1]; // Extract time from end date
//       bookedTimes.push({ start: startTime, end: endTime });
//     });
...
//         // Check if the time slot is booked
//         const isTimeSlotBooked = bookedTimes.some((bookedTime) => {
//           return (
//             bookedTime.start === `${slot.start.hour}:${slot.start.minute}` &&
//             bookedTime.end === `${slot.end.hour}:${slot.end.minute}`
//           );
//         });
...
//     return hasData && isAfterToday && view === "month" ? (
